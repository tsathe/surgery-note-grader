-- Update rubric domains to match the new surgical consult rubric
-- This migration updates the existing rubric domains with the enhanced criteria

-- First, clear existing rubric domains
DELETE FROM rubric_domains;

-- Insert the updated rubric domains from the JSON file
INSERT INTO rubric_domains (name, description, examples, max_score, "order", score_guidance) VALUES
(
  'History, Physical, and Data',
